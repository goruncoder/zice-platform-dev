...
**Local full stack:** Clone [zice-platform-dev](https://github.com/goruncoder/zice-platform-dev), run `make clone`, then `make dev` or `make check` to lint/test core + frontend + agent together.
